...
main(int argc, char *argv[])
{
  ...
  33:	ff 33                	pushl  (%ebx)
  35:	e8 41 04 00 00       	call   47b <mkdir>
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 24 09 00 00 	movzbl 0x924(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 704:	eb 1a                	jmp    720 <printf+0x1a0>
          s = "(null)";
 706:	bb 1b 09 00 00       	mov    $0x91b,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 755:	a1 90 0c 00 00       	mov    0xc90,%eax
{
 ...
 776:	73 10                	jae    788 <free+0x38>
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	a3 90 0c 00 00       	mov    %eax,0xc90
}
 7a7:	5e                   	pop    %esi
 7a8:	5f                   	pop    %edi
 7a9:	5d                   	pop    %ebp
 ...
 7c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ca:	a3 90 0c 00 00       	mov    %eax,0xc90
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7f0:	8b 3d 90 0c 00 00    	mov    0xc90,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 839:	8b 3d 90 0c 00 00    	mov    0xc90,%edi
 ...
 862:	e8 e9 fe ff ff       	call   750 <free>
  return freep;
 867:	a1 90 0c 00 00       	mov    0xc90,%eax
 ...
 894:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 897:	a3 90 0c 00 00       	mov    %eax,0xc90
}
 ...
 8ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 90 0c 00 00 94 	movl   $0xc94,0xc90
 8b7:	0c 00 00 
    base.s.size = 0;
 8ba:	bf 94 0c 00 00       	mov    $0xc94,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 94 0c 00 00 94 	movl   $0xc94,0xc94
 8c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8cb:	c7 05 98 0c 00 00 00 	movl   $0x0,0xc98
 8d2:	00 00 00 
    if(p->s.size >= nunits){

...
main(int argc, char *argv[])
{
  ...
  38:	68 e8 08 00 00       	push   $0x8e8
  3d:	83 c3 04             	add    $0x4,%ebx
  40:	50                   	push   %eax
  41:	68 ea 08 00 00       	push   $0x8ea
  46:	6a 01                	push   $0x1
  48:	e8 33 05 00 00       	call   580 <printf>
  for(i = 1; i < argc; i++)
  ...
  57:	68 ef 08 00 00       	push   $0x8ef
  5c:	50                   	push   %eax
  5d:	68 ea 08 00 00       	push   $0x8ea
  62:	6a 01                	push   $0x1
  64:	e8 17 05 00 00       	call   580 <printf>
  69:	83 c4 10             	add    $0x10,%esp
  exit();
  6c:	e8 a2 03 00 00       	call   413 <exit>
  71:	66 90                	xchg   %ax,%ax
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
 ...
 4dc:	89 d1                	mov    %edx,%ecx
{
 ...
 509:	0f b6 92 f8 08 00 00 	movzbl 0x8f8(%edx),%edx
...
printf(int fd, const char *fmt, ...)
{
 ...
 704:	eb 1a                	jmp    720 <printf+0x1a0>
          s = "(null)";
 706:	bb f1 08 00 00       	mov    $0x8f1,%ebx
        while(*s != 0){
 ...
 776:	73 10                	jae    788 <free+0x38>
{
 ...
 7a1:	5b                   	pop    %ebx
  freep = p;
 7a2:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 7a7:	5e                   	pop    %esi
 7a8:	5f                   	pop    %edi
 7a9:	5d                   	pop    %ebp
 ...
 7c7:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 7ca:	a3 5c 0c 00 00       	mov    %eax,0xc5c
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 7ed:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 7f0:	8b 3d 5c 0c 00 00    	mov    0xc5c,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 839:	8b 3d 5c 0c 00 00    	mov    0xc5c,%edi
 ...
 862:	e8 e9 fe ff ff       	call   750 <free>
  return freep;
 867:	a1 5c 0c 00 00       	mov    0xc5c,%eax
 ...
 894:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 897:	a3 5c 0c 00 00       	mov    %eax,0xc5c
}
 ...
 8ae:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 8b0:	c7 05 5c 0c 00 00 60 	movl   $0xc60,0xc5c
 8b7:	0c 00 00 
    base.s.size = 0;
 8ba:	bf 60 0c 00 00       	mov    $0xc60,%edi
    base.s.ptr = freep = prevp = &base;
 8bf:	c7 05 60 0c 00 00 60 	movl   $0xc60,0xc60
 8c6:	0c 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 8c9:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 8cb:	c7 05 64 0c 00 00 00 	movl   $0x0,0xc64
 8d2:	00 00 00 
    if(p->s.size >= nunits){

...
main(void)
{
  ...
  exit();
   f:	e8 cf 04 00 00       	call   4e3 <exit>
  14:	66 90                	xchg   %ax,%ax
  16:	66 90                	xchg   %ax,%ax
  18:	66 90                	xchg   %ax,%ax
  1a:	66 90                	xchg   %ax,%ax
...
00000020 <printf>:
{
  ...
  3c:	e8 c2 04 00 00       	call   503 <write>
}
  ...
  58:	31 db                	xor    %ebx,%ebx
{
  ...
  write(fd, s, strlen(s));
  5d:	68 38 07 00 00       	push   $0x738
  62:	e8 69 01 00 00       	call   1d0 <strlen>
  67:	83 c4 0c             	add    $0xc,%esp
  6a:	50                   	push   %eax
  6b:	68 38 07 00 00       	push   $0x738
  70:	6a 01                	push   $0x1
  72:	e8 8c 04 00 00       	call   503 <write>
  ...
  8b:	0f 84 92 00 00 00    	je     123 <forktest+0xd3>
    pid = fork();
  91:	e8 45 04 00 00       	call   4db <fork>
    if(pid < 0)
  ...
  if(wait() != -1){
  ae:	e8 38 04 00 00       	call   4eb <wait>
  b3:	83 f8 ff             	cmp    $0xffffffff,%eax
  b6:	75 49                	jne    101 <forktest+0xb1>
  write(fd, s, strlen(s));
  b8:	83 ec 0c             	sub    $0xc,%esp
  bb:	68 6a 07 00 00       	push   $0x76a
  c0:	e8 0b 01 00 00       	call   1d0 <strlen>
  c5:	83 c4 0c             	add    $0xc,%esp
  c8:	50                   	push   %eax
  c9:	68 6a 07 00 00       	push   $0x76a
  ce:	6a 01                	push   $0x1
  d0:	e8 2e 04 00 00       	call   503 <write>
}
  d5:	8b 5d fc             	mov    -0x4(%ebp),%ebx
  d8:	c9                   	leave  
  d9:	c3                   	ret    
      exit();
  da:	e8 04 04 00 00       	call   4e3 <exit>
  write(fd, s, strlen(s));
  ...
  ef:	50                   	push   %eax
  f0:	68 43 07 00 00       	push   $0x743
  f5:	6a 01                	push   $0x1
  f7:	e8 07 04 00 00       	call   503 <write>
      exit();
  fc:	e8 e2 03 00 00       	call   4e3 <exit>
  write(fd, s, strlen(s));
 101:	83 ec 0c             	sub    $0xc,%esp
 104:	68 57 07 00 00       	push   $0x757
 109:	e8 c2 00 00 00       	call   1d0 <strlen>
 10e:	83 c4 0c             	add    $0xc,%esp
 111:	50                   	push   %eax
 112:	68 57 07 00 00       	push   $0x757
 117:	6a 01                	push   $0x1
 119:	e8 e5 03 00 00       	call   503 <write>
    exit();
 11e:	e8 c0 03 00 00       	call   4e3 <exit>
  write(fd, s, strlen(s));
 123:	83 ec 0c             	sub    $0xc,%esp
 126:	68 78 07 00 00       	push   $0x778
 12b:	e8 a0 00 00 00       	call   1d0 <strlen>
 130:	83 c4 0c             	add    $0xc,%esp
 133:	50                   	push   %eax
 134:	68 78 07 00 00       	push   $0x778
 139:	6a 01                	push   $0x1
 13b:	e8 c3 03 00 00       	call   503 <write>
    exit();
 140:	e8 9e 03 00 00       	call   4e3 <exit>
...
int thread_create(void (*start_routine)(void *, void *), void *arg1, void *arg2) {
 ...
 3c0:	e8 6b 02 00 00       	call   630 <malloc>
  if (stack == 0)
 ...
 40e:	53                   	push   %ebx
 40f:	e8 8c 01 00 00       	call   5a0 <free>
...
int thread_join() {
 ...
 43b:	6a 04                	push   $0x4
 43d:	e8 ee 01 00 00       	call   630 <malloc>
 ...
 45a:	56                   	push   %esi
 45b:	e8 40 01 00 00       	call   5a0 <free>
...
free(void *ap)
{
 ...
 5a5:	a1 c4 0a 00 00       	mov    0xac4,%eax
{
 ...
 5c6:	73 10                	jae    5d8 <free+0x38>
{
 ...
 5f1:	5b                   	pop    %ebx
  freep = p;
 5f2:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 5f7:	5e                   	pop    %esi
 5f8:	5f                   	pop    %edi
 5f9:	5d                   	pop    %ebp
 ...
 617:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 61a:	a3 c4 0a 00 00       	mov    %eax,0xac4
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 63d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 640:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 689:	8b 3d c4 0a 00 00    	mov    0xac4,%edi
 ...
 69b:	e8 cb fe ff ff       	call   56b <sbrk>
  if(p == (char*)-1)
 ...
 6b2:	e8 e9 fe ff ff       	call   5a0 <free>
  return freep;
 6b7:	a1 c4 0a 00 00       	mov    0xac4,%eax
 ...
 6e4:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 6e7:	a3 c4 0a 00 00       	mov    %eax,0xac4
}
 ...
 6fe:	66 90                	xchg   %ax,%ax
    base.s.ptr = freep = prevp = &base;
 700:	c7 05 c4 0a 00 00 c8 	movl   $0xac8,0xac4
 707:	0a 00 00 
    base.s.size = 0;
 70a:	bf c8 0a 00 00       	mov    $0xac8,%edi
    base.s.ptr = freep = prevp = &base;
 70f:	c7 05 c8 0a 00 00 c8 	movl   $0xac8,0xac8
 716:	0a 00 00 
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 719:	89 f8                	mov    %edi,%eax
    base.s.size = 0;
 71b:	c7 05 cc 0a 00 00 00 	movl   $0x0,0xacc
 722:	00 00 00 
    if(p->s.size >= nunits){
